...
export declare const patchDocument: <T extends PatchDocumentOutputType = PatchDocumentOutputType>({ outputType, data, patches, keepOriginalStyles, placeholderDelimiters, recursive, numbering, }: PatchDocumentOptions<T>) => Promise<OutputByType[T]>;
